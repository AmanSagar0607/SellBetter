  ...
  return (
    <div className="min-h-screen bg-black/95 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 -left-4 w-72 h-72 bg-pink-500/30 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob" />
      ...
      <div className="relative px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
        <motion.div 
          className="flex flex-col items-center justify-center text-center space-y-12 max-w-5xl mx-auto"
          initial="hidden"
          animate="show"
          variants={container}
        >
          <motion.div className="space-y-6" variants={item}>
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold bg-gradient-to-r from-white via-pink-400 to-purple-500 text-transparent bg-clip-text tracking-tight">
        ...
        {/* Product Grid */}
        <motion.div 
          className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 relative max-w-[1400px] mx-auto"
          variants={container}
        >
          {/* Glow Effect */}

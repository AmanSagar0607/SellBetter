...
function Header() {
    ...
    return (
        <div className="sticky top-0 z-50 bg-black/95 backdrop-blur-sm">
            <div className="relative flex items-center justify-between p-4 px-4 sm:px-8 lg:px-32 xl:px-36 border-b border-white/10">
                {/* Menu Toggle Button */}
                <button
                    onClick={toggleMenu}
                ...
                <h2 className="text-[22px] sm:text-[28px] font-bold shrink-0 flex items-center gap-2">
                    <Link href="/" className="flex items-center gap-2">
                        <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            />
                            <path
                                d="M7 19L15 11M15 11H10M15 11V16"
                                stroke="#EE519F"
                                strokeWidth="2.5"
                                strokeLinecap="round"
                                strokeLinejoin="round"
                        ...
                        <span className="text-[#EE519F]">SellBetter</span>
                    </Link>
                </h2>
                    ...
                    {isSignedIn ? (
                        <>
                            <Link href="/dashboard" className="hidden sm:block">
                                <Button className="relative group px-4 py-2 bg-white/5 hover:bg-white/10 text-white border border-white/10 transition-colors duration-300">
                                    Dashboard
                        ...
                        <Link href="/sign-in">
                            <Button className="relative group px-4 py-2 bg-pink-500/10 hover:bg-pink-500/20 text-pink-400 hover:text-pink-300 border border-pink-500/20 transition-colors duration-300">
                                Sign In
